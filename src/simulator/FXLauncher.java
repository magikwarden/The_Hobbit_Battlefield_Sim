...
public class FXLauncher extends Application {
  ...
  private MenuBar createMenuBar() {
	...
	MenuItem save = new MenuItem("S_ave"); save.setOnAction(event->simulator.save());
	MenuItem restore = new MenuItem("Res_tore"); restore.setOnAction(event->simulator.restore());
	Menu menuFile = new Menu("_File"); menuFile.getItems().addAll(save, restore);
    
	// Create the "Run" Menu
    MenuItem populateMenuItem = new MenuItem("_Populate"); 	populateMenuItem.setOnAction(event->simulator.populate());	// create CALLBACK, that is, the code to execute when triggered by user event (in this case, simulator.populate())
    MenuItem runMenuItem = new MenuItem("_Run"); 			runMenuItem.setOnAction(event->simulator.run());						// create CALLBACK, that is, the code to execute when triggered by user event (in this case, simulator.run())
    MenuItem suspendMenuItem = new MenuItem("_Suspend"); 	suspendMenuItem.setOnAction(event->simulator.suspend());		// create CALLBACK, that is, the code to execute when triggered by user event (in this case, simulator.suspend())
