...
public class FXLauncher extends Application
{
	...
	{ // try-catch block implemented to manage
	  // potential file loading issues.
	...
	menuRun.getItems().addAll(populateMenuItem, runMenuItem, suspendMenuItem, clearMenuItem); // assemble MenuItems
												  // in the "Run"
	// Menu
