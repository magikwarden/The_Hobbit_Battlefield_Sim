...
/**
 * <i>Singleton</i> class that provides a simplified interface to random number
 * generation using a Gaussian (normal) distribution.
 */
public class SingletonRandom
{
    /**
     * public final static gives immutable access to reference-to variable of the
     * single object of type <i>SingletonRandom</i>
     */
    ...
    /**
     * private constructor is a key element in <i>Singleton</i> design pattern; no
     * object of type SingletonRandom can ever be created outside the class.
     */
	...
	do
	{
	    // next.Gaussian() returns a value with 1-standard deviation worth range between
	    // -1.0 and +1.0 (i.e. about 68% of values)
